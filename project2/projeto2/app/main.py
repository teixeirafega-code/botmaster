...
async def dashboard() -> None:
    ...
    print("Dashboard do Domain Hunter Bot")
    print("===========================")
    print(f"Dominios monitorados: {snapshot['domains_monitored']}")
    print(f"Registrados:          {snapshot['registered']}")
    print(f"Vendidos:             {snapshot['sold']}")
    print(f"Total investido:      ${snapshot['total_invested']}")
    print(f"Lucro total:          ${snapshot['total_profit']}")
    print(f"Valor do portfolio:   ${snapshot['total_portfolio_value']}")
    print(f"Modo paper:           {settings.paper_mode}")
...
async def portfolio_report() -> None:
    ...
    try:
        ...
        print("Portfolio")
        print("=========")
        print(f"Dominios:          {snapshot['domains_monitored']}")
        print(f"Registrados:       {snapshot['registered']}")
        print(f"Vendidos:          {snapshot['sold']}")
        print(f"Investido:         ${snapshot['total_invested']}")
        print(f"Valor do portfolio: ${snapshot['total_portfolio_value']}")
        print(f"Lucro realizado:   ${snapshot['total_profit']}")
